import { useFetchMuscles } from "@/app/hooks/useFetchMuscles";
...
const MuscleCard = () => {
  ...
  return (
    <Link href={`/muscle/=`} className="grid grid-cols-2 gap-8 lg:grid-cols-3">
      {muscles.map((muscle: any) => (
        <div key={muscle.ID} className="flex flex-col">
